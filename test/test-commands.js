...
const { wrapInList, splitListItem, liftListItem, popListItem, sinkListItem, slideUpListItem, slideDownListItem } = require("..")
...
describe("slideUpListItem", () => {
  let slideUp = slideUpListItem(schema.nodes.list_item)

  it("slides the item up to the position before its elder sibling", () =>
    apply(
      doc(ul(li(p("1"), ul(li(p("1-1"), ul(li(p("1-1-1")))))),
      li(p("2"), ul(li("2-1"), li(p("2<a><b>-2"), ul(li(p("2-2-1")))))),
        li(p("3"), ul(li(p("3-1"), ul(li(p("3-1-1"))))))
      )
      ),
      slideUp,
      doc(ul(li(p("1"), ul(li(p("1-1"), ul(li(p("1-1-1")))))),
        li(p("2"), ul(li(p("2-2"), ul(li(p("2-2-1")))), li("2-1"))),
        li(p("3"), ul(li(p("3-1"), ul(li(p("3-1-1"))))))
      )
      )
    )
  ...
  it("removes parent and slides the item up to the position after its cousin when it is only child", () =>
    apply(
      doc(ul(li(p("1"), ul(li(p("1-1"), ul(li(p("1-1-1")))))),
      ...
      slideUp,
      doc(ul(li(p("1"), ul(li(p("1-1"), ul(li(p("1-1-1")))), li(p("2-1"), ul(li(p("2-1-1")))))),
        li(p("2")),
        li(p("3"), ul(li(p("3-1"), ul(li(p("3-1-1"))))))
      )
      )
  ...
  it("keeps parent and slides the item up to the position after its cousin when it has siblings", () =>
    apply(
      doc(ul(li(p("1"), ul(li(p("1-1"), ul(li(p("1-1-1")))))),
  ...
  it("slides the item up to the position after its uncle who does not have a child", () =>
    apply(
      doc(ul(li(p("1")),
        li(p("2"), ul(li(p("2<a><b>-1"), ul(li(p("2-1-1")))), li("2-2"))),
        li(p("3"), ul(li(p("3-1"), ul(li(p("3-1-1"))))))
      ...
      slideUp,
      doc(ul(li(p("1"), ul(li(p("2-1"), ul(li(p("2-1-1")))))),
        li(p("2"), ul(li("2-2"))),
        li(p("3"), ul(li(p("3-1"), ul(li(p("3-1-1"))))))
      )
      )
...
describe("slideDownListItem", () => {
  ...
  it("keeps parent and slides the item down to the position before its cousin when it has siblings", () =>
    apply(
      doc(ul(li(p("1"), ul(li(p("1-1"), ul(li(p("1-1-1")))))),
        li(p("2"), ul(li("2-1"), li(p("2<a><b>-2"), ul(li(p("2-2-1")))))),
        li(p("3"), ul(li(p("3-1"), ul(li(p("3-1-1"))))))
  ...
  it("slides the item down to the position before its uncle who does not have a child", () =>
    apply(
      doc(ul(li(p("1"), ul(li(p("1-1"), ul(li(p("1-1-1")))))),
        li(p("2"), ul(li("2-1"), li(p("2<a><b>-2"), ul(li(p("2-2-1")))))),
        li(p("3"))
